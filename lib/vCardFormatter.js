...
(function vCardFormatter()
{
	...
	function getPhotoContentLine(prop, photo)
	{
		...
		// In v2.1/3.0 an inline base64 binary value must be terminated by a blank line.
		//   Some parsers (notably Samsung devices) refuse to import the whole vCard
		//   when it is missing. See issue #58.
		if (photo.base64 && majorVersion < 4)
			return line + "\r\n";

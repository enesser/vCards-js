        ...
        getFormattedString: function(vCard) {
            ...
            if (vCard.customSocialUrls) {
                vCard.customSocialUrls.forEach((socialProfile, index) => {
                    formattedVCardString += 'item' + (index + 1) + '.X-SOCIALPROFILE' + encodingPrefix + ':' + e(socialProfile) + nl();
                    formattedVCardString += 'item' + (index + 1) + '.X-ABLABEL' + encodingPrefix + ':' + e(vCard.socialUrlsLabel[index]) +nl();
                })
            }
